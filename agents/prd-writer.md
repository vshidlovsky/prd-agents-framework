...
| User-facing packs (screen-flow, navigation, design-prototype) | Produce — inserted into the Behavioral Contract per their `slim` insertion tags | Produce — inserted into the Technical Contract |
